      ...
      <div className="container mx-auto px-2 sm:px-4">
        <div className="flex items-center justify-between h-14 sm:h-16">
          <Link href="/" passHref legacyBehavior>
            <a className="flex items-center cursor-pointer" aria-label="StockPilot Home">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[220px] sm:w-[250px] bg-primary p-3 pt-6 sm:p-4 sm:pt-8">
                <div className="mb-4 sm:mb-6">
                   <Link href="/" passHref legacyBehavior>
                    <a className="flex items-center cursor-pointer" aria-label="StockPilot Home" onClick={() => setIsMobileMenuOpen(false)}>
                      <Logo className="h-7 sm:h-8 w-auto" />
                    </a>
                  </Link>
                </div>
